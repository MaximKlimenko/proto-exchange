...
type ExchangeServiceClient interface {
	...
	GetExchangeRates(ctx context.Context, in *CurrencyRequest, opts ...grpc.CallOption) (*ExchangeRatesResponse, error)
...
func (c *exchangeServiceClient) GetExchangeRates(ctx context.Context, in *CurrencyRequest, opts ...grpc.CallOption) (*ExchangeRatesResponse, error) {
...
type ExchangeServiceServer interface {
	// Получение курсов обмена всех валют
	GetExchangeRates(context.Context, *CurrencyRequest) (*ExchangeRatesResponse, error)
	// Получение курса обмена для конкретной валюты
...
func (UnimplementedExchangeServiceServer) GetExchangeRates(context.Context, *CurrencyRequest) (*ExchangeRatesResponse, error) {
...
func _ExchangeService_GetExchangeRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeServiceServer).GetExchangeRates(ctx, req.(*CurrencyRequest))
	}
